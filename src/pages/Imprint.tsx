      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-3xl prose prose-slate dark:prose-invert">
            ...
            <h2>{language === 'de' ? 'Anschrift' : 'Address'}</h2>
            <p>
              Förderverein der Neuapostolischen Kirchengemeinde Hamburg-Alstertal e.V.<br />
              Dweerblöcken 8<br />
              22393 Hamburg
            </p>

            <h2>{language === 'de' ? 'Vorstand' : 'Board'}</h2>
            <p>
              Anja Link, Torsten Müller, Silke Schürenberg
            </p>

            <h2>{language === 'de' ? 'Kontakt' : 'Contact'}</h2>
            <p>
              <a href="mailto:verein@nak-alstertal.de" className="text-primary hover:underline">
