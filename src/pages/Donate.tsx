  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-lg border-0">
            <CardHeader>
              ...
              <CardTitle className="text-foreground">{t('donate.bank.title')}</CardTitle>
            </CardHeader>
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-lg border-0">
            <CardHeader>
              ...
              <CardTitle className="text-foreground">{t('donate.paypal.title')}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        {/* Receipt Info */}
        <Card className="mt-8 bg-white/95 backdrop-blur-sm shadow-lg border-0">
          <CardHeader>
            <div className="mb-2 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
              <Receipt className="h-6 w-6" />
            </div>
            <CardTitle className="text-foreground">{t('donate.receipt.title')}</CardTitle>
          </CardHeader>
          <CardContent>
            <CardDescription className="text-base">
