...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'about.subtitle': 'Unser Ziel ist es, einen bleibenden Beitrag zur Förderung des kirchlichen Lebens und der sozialen Gemeinschaft zu leisten.',
    ...
    'donate.bank.bank': 'Bank: Hamburger Sparkasse',
  ...
  en: {
    ...
    'about.subtitle': 'Our goal is to make a lasting contribution to the promotion of church life and the social community.',
